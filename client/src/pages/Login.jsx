    ...
    <div>
      ...
      <div className=" bg-slate-200 mt-4">
        <div className=" w-full justify-center items-center p-10">
          <div className=" grid grid-cols-2 w-[60%] md:grid-cols-1 mx-auto bg-white rounded-md">
                  ...
                  <a
                    href={
                      mode === "dev"
                        ...
                        : "https://myshop-dashboard-lemon.vercel.app/register"
                    }
                    target="blank"
            ...
            <div className=" w-full h-full py-4 pr-4">
              <img
                className=" w-full h-[80%] md:hidden"
