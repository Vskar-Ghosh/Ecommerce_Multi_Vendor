...
const Sidebar = ({ showSidebar, setShowSidebar }) => {
  ...
  return (
    <div>
      ...
      ></div>
      <div
        className={` w-[260px] fixed bg-[#737d98] z-50 top-0 h-screen shadow-[0_0_15px_0_rgb(34_41_47_/_5%)] transition-all ${
          ...
          <ul>
            ...
            <li>
              <button
                ...
                className=" text-[#d0d2d6] font-normal  duration-200 px-[12px] py-[9px] rounded-sm flex justify-start items-center gap-[12px] hover:pl-4 transition-all w-full"
              >
                <span>
                  <BiLogOutCircle />
                </span>
